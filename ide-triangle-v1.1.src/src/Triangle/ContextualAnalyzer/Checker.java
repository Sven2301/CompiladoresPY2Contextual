...
import Triangle.AbstractSyntaxTrees.NextCaseLiteral;//Agregado
...
public final class Checker implements Visitor {
  ...
  public Object visitSequentialCommand(SequentialCommand ast, Object o) {
    ...
    // AGREGADO @Steven
  //De momento no se implementará ya que no es necesario para la primera fase del proyecto
  ...
  */
  ...
  // AGREGADO @Steven
  //De momento no se implementará ya que no es necesario para la primera fase del proyecto
  public Object visitRepeatForInCommand(RepeatForInCommand ast, Object o) {return null;}

    // AGREGADO @Steven
  //De momento no se implementará ya que no es necesario para la primera fase del proyecto
  public Object visitRepeatForRangeDoCommand(RepeatForRangeDoCommand ast, Object o) {return null;}
  
  // AGREGADO @Steven
  //De momento no se implementará ya que no es necesario para la primera fase del proyecto
  public Object visitRepeatForRangeUntilCommand(RepeatForRangeUntilCommand ast, Object o) {return null;}
  
  // AGREGADO @Steven
  //De momento no se implementará ya que no es necesario para la primera fase del proyecto
  public Object visitRepeatForRangeWhileCommand(RepeatForRangeWhileCommand ast, Object o) {return null;}

  // AGREGADO @Steven
  //De momento no se implementará ya que no es necesario para la primera fase del proyecto
  public Object visitRepeatDoWhileCommand(RepeatDoWhileCommand ast, Object o) {return null;}
  
  
  // AGREGADO @Steven
  //De momento no se implementará ya que no es necesario para la primera fase del proyecto
  public Object visitRepeatDoUntilCommand(RepeatDoUntilCommand ast, Object o) {return null;}
  
  // AGREGADO @Steven
  //De momento no se implementará ya que no es necesario para la primera fase del proyecto
  public Object visitRepeatWhileCommand(RepeatWhileCommand ast, Object o) {return null;}
  
  
  // AGREGADO @Steven
  //De momento no se implementará ya que no es necesario para la primera fase del proyecto
  public Object visitRepeatUntilCommand(RepeatUntilCommand ast, Object o) {return null;}
  ...
  // AGREGADO @Steven
  //De momento no se implementará ya que no es necesario para la primera fase del proyecto
  public Object visitPrivDeclaration(PrivDeclaration ast, Object o) {return null;}
  ...
  public Object visitVarDeclaration(VarDeclaration ast, Object o) {
   ...
   // AGREGADO @Steven
  //De momento no se implementará ya que no es necesario para la primera fase del proyecto
  public Object visitVar2Declaration(Var2Declaration ast, Object o) {return null;}
